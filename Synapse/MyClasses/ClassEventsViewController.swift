...
//    var currentEventsArray = [Events]()
    ...
    var tableCourse = Course(course: "", teacher: "")
...
//    }
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        label.text = tableCourse.course + " - " + tableCourse.teacher
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "Cell") as? ClassEventsTableViewCell else {
